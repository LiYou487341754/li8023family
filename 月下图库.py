...
for i in range(len(img_data)):
    if updateNo == 'T':
        if len(str(time.localtime().tm_mon)) == 1 and len(str(time.localtime().tm_mday)) != 1:
            localtime = (str(time.localtime().tm_year) + '0' +
                         str(time.localtime().tm_mon) + str(time.localtime().tm_mday))
        elif len(str(time.localtime().tm_mon)) == 1 and len(str(time.localtime().tm_mday)) == 1:
            localtime = (str(time.localtime().tm_year) + '0' +
                         str(time.localtime().tm_mon) + '0' + str(time.localtime().tm_mday))
        elif len(str(time.localtime().tm_mon)) != 1 and len(str(time.localtime().tm_mday)) == 1:
            localtime = (str(time.localtime().tm_year) +
                         str(time.localtime().tm_mon) + '0' + str(time.localtime().tm_mday))
        else:
